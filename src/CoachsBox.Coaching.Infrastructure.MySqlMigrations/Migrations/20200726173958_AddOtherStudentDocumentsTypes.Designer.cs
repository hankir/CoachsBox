...
namespace CoachsBox.Coaching.Infrastructure.MySqlMigrations.Migrations
{
    ...
    [Migration("20200726173958_AddOtherStudentDocumentsTypes")]
    partial class AddOtherStudentDocumentsTypes
    {
            ...
            modelBuilder.Entity("CoachsBox.Coaching.StudentDocumentModel.StudentDocument", b =>
                {
                    b.HasOne("CoachsBox.Coaching.StudentModel.Student", "Student")
                        .WithOne()
                        .HasForeignKey("CoachsBox.Coaching.StudentDocumentModel.StudentDocument", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
