...
{
  public class SalaryPaymentsPeriodEndingChangedEventHandler : INotificationHandler<SalaryPaymentsPeriodEndingChangedEvent>
  {
    private readonly IMediator mediator;

    public SalaryPaymentsPeriodEndingChangedEventHandler(IMediator mediator)
    {
      this.mediator = mediator;
    }

    public async Task Handle(SalaryPaymentsPeriodEndingChangedEvent notification, CancellationToken cancellationToken)
    {
